...
\
\
The **"subspecies" and "female_body_mass_at_maturity_g"** variables have the most NA's.  In fact, they both have 100% NA's for their values.
\
\
...
\
\
In order from most NA's to least, it is mammals, then reptiles, and finally birds.  Notably, mammals have 100% NA's for egg mass.  However, this makes sense biologically since most mammals don't lay eggs.  This suggests that NA's do not always indicate missing data.  Rather, in some cases, they represent variables that do not make sense biologically.
\
\
## Knit and Upload
