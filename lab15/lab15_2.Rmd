...
ui <- fluidPage(
  titlePanel("Density Distribution of Variables by Order"),
  selectInput(
    "x",
    "Select Mammalian Order",
    choices = sort(unique(gestation$order)), # Select all unique orders as choices (avoids typing in orders one by one)
    selected = "Rodentia"
  ),
...
ui <- dashboardPage(
  ...
  dashboardSidebar(disable = TRUE), # turns off sidebar
...
ui <- 
  ...
  dashboardHeader(title = "Sex Composition of Wolf Packs by Population"),
