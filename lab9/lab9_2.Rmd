...
```
Note: Best if there is no character separating them (ex. "_").
...
tb_data %>% 
  pivot_wider(
    names_from = "key", # Pulls names from key
    values_from = "value" # Pulls values from value
  )
```
